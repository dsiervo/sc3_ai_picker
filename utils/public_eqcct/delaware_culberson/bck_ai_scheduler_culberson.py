...
def runner(every_m, delay=0, db='10.100.100.13:4803', ai_picker='ai_picker.py'):
    ...
    if output_path is not None:
        ...
        if os.path.getsize(output_path):
            ...
            ic(os.system(cmd))
            # send to sc5
            send_to_sc5(output_path, f'cultx{num}', test=True)
            ...
            #EventTypeChanger('scdb.beg.utexas.edu', user='sysro', passwd='0niReady', scroot='/home/siervod/seiscomp').run()
        else:
            print('\n\n\tArchivo vacio!\n\n')
    else:
        print('\n\n\tNo existe mag.xml!\n\n')
...
#    """
#    cmd = f"send_to_sc5.py {xml_path} {usr}"
#    print(cmd)
#    os.system(cmd)
